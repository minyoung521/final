...
urlpatterns = [
    ...
    path('dorminfo/', views.dorm_info_view, name='dorminfo'),
    ...
    path('outside/manage/', views.outing_info, name='outside_manage'),
    ...
    path('apply_outing/', views.apply_outing, name='apply_outing'),
